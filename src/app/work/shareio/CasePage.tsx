...
export function CasePage() {
  ...
  return (
    <main className="pb-10">
      ...
      <SectionMedia>
        <video className="w-full aspect-[3840/2494]" src="https://klad.b-cdn.net/F_08%20font_2.mp4" autoPlay loop muted playsInline preload="auto" webkit-playsinline="true"/>
      </SectionMedia>
