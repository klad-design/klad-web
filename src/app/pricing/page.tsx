...
export default function Pricing() {
  return (
    <section className="md:flex md:flex-col md:min-h-svh pb-2.5 pt-[65px] md:pt-[150px] lg:pt-0">
      <h1 className="md:text-nowrap text-[20vw] md:text-[min(100px,12vw)] lg:text-[10.5vw] tracking-normal leading-[90%] uppercase -ml-1.5 lg:-ml-2.5 -rotate-2">
        <TextBlur isBold>
          Pricing
          {' '}
      ...
      <div className="relative mt-10 md:mt-12 lg:my-auto overflow-hidden">
        ...
        <img className="dark:invert w-auto max-w-fit h-[122px] md:h-[194px] xl:h-[332px] 2xl:h-[440px] -ml-10 md:-ml-[68px] xl:-ml-[120px] 2xl:-ml-[150px]" src="/images/coins.svg" alt="Coins" width={1900} height={440} loading="eager" fetchPriority="high" />
      </div>
